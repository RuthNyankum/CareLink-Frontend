...
import backgroundImage from '../../assets/images/abs.jpeg'; // Replace with your background image path
...
const Appointment = () => {
  return (
    <>
      <Navbar />
      <div
        className="min-h-screen p-6 md:p-12 lg:p-16 mt-7 font-poppins-regular bg-cover bg-center"

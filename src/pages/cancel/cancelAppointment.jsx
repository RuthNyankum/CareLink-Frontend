...
//       <div className="relative bg-black/85 text-gray-900 p-6 md:p-12 lg:p-16 rounded-xl shadow-lg w-full max-w-2xl">
//         <button
//           onClick={onClose}
...
const CancelAppointment = ({ currentAppointment, onClose }) => {
  ...
  return (
    <div
      className="bg-cover bg-center min-h-screen flex items-center justify-center p-6 md:p-12 lg:p-16"
      // style={{ backgroundImage: `url(${abstract})` }}
    >
      <div className="relative bg-white/10 backdrop-blur-lg text-gray-900 p-6 md:p-12 lg:p-16 rounded-xl shadow-lg w-full max-w-2xl">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-400 hover:text-gray-600"
        >

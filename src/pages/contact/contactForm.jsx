...
const ContactForm = () => {
  ...
  return (
    <div className="flex justify-center items-center p-4 mb-5 ">
      <div className="bg-white/30 backdrop-blur-lg rounded-lg shadow-lg p-8 w-full max-w-5xl mx-auto border border-white/40 mt-32">
        <form
          onSubmit={handleSubmit}
          className="w-full max-w-3xl mx-auto text-lg"
        >
          <div className="mb-4">
            ...
            <input
              className="bg-white/70 shadow appearance-none border-none rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="name"
              type="text"
              name="name"
              placeholder="Your Name"

...
//           </p>
//           <div>
//             <p className="font-bold mb-2 text-3xl">Mission Statement</p>
...
//             src={patient}
//             alt="Patient"
//             className="h-[600px] w-[700px] rounded-br-full rounded-t-full"
//           />
//         </div>
...
//             src={doctor}
//             alt="Doctor"
//             className="h-[600px] w-[700px] rounded-b-full rounded-tl-full"
//           />
//         </div>
//       </div>
...
//         width="100%"
//         height="200px"
//         viewBox="0 0 1200 200" // Increased viewBox width
//         fill="none"
//         xmlns="http://www.w3.org/2000/svg"
//       >
//         <path
...
const AboutHero = () => {
  return (
    <div className="mt-32 mx-auto max-w-7xl relative px-4">
      <div className="flex flex-col lg:flex-row justify-around items-center relative z-10">
        {/* Patient Image */}
        <div className="w-full lg:w-[600px] mb-8 lg:mb-0 mt-20">
          <img
            src={patient}
            alt="Patient"
            className="w-full h-auto max-w-[700px] rounded-br-full rounded-t-full object-cover"
          />
        </div>
        ...
        {/* Doctor Image */}
        <div className="w-full lg:w-[600px] mb-20">
          <img
            src={doctor}
            alt="Doctor"
            className="w-full h-auto max-w-[700px] rounded-b-full rounded-tl-full object-cover"
          />
        </div>
      </div>
